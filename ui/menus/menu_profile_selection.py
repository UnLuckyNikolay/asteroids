...
from player.player_stats import get_ship_id
...
class MenuProfileSelection(_MenuBase):
    def __init__(
        self,
        ...
        offset_x = int(res[0]/2-400)
        offset_y = int(res[1]/2-285)
        ...
        if gsm._profiles[0] != None:
            ...
            b_pf0.add_element(
                Ship(
                    get_ship_id(gsm._profiles[0]["player_stats_save"].get("ship_model_index", gsm._default_ship_index)),
        ...
        if gsm._profiles[1] != None:
            ...
            b_pf1.add_element(
                Ship(
                    get_ship_id(gsm._profiles[1]["player_stats_save"].get("ship_model_index", gsm._default_ship_index)),
        ...
        if gsm._profiles[2] != None:
            ...
            b_pf2.add_element(
                Ship(
                    get_ship_id(gsm._profiles[2]["player_stats_save"].get("ship_model_index", gsm._default_ship_index)),
