...
class MenuPause(_MenuBase):
    def __init__(
        ...
        self.input_handlers = {
            Action.MENU_BACK : gsm.unpause_game
        }

        # Space between elements - 15
        if gsm.player.stats.cheat_cleavers:
            bg_height = 525
        else: 
            bg_height = 423
        offset_x = int((gsm.screen_resolution[0] - 1280)/2)
        offset_y = int((gsm.screen_resolution[1] - bg_height - 180)/2)
        row_height = 51
        column_1 = 290
        column_2 = 760
        ...
        c_engine.add_element(
            TextUpdated(
                ...
                lambda: gsm.player.get_part_level(ShipPart.ENGINE)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_engine.add_conditional_override(
            lambda: gsm.player.get_part_level(ShipPart.ENGINE) >= gsm.player.get_part_level_max(ShipPart.ENGINE),
        ...
        c_engine_speed.add_element(
            TextUpdated(
                ...
                lambda: gsm.player.get_upgrade_price_as_text(ShipUpgrade.ENGINE_SPEED)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_engine_speed.add_conditional_override(
            lambda: gsm.player.get_upgrade_level(ShipUpgrade.ENGINE_SPEED) >= gsm.player.get_upgrade_level_max(ShipUpgrade.ENGINE_SPEED),
        ...
        c_engine_acc.add_element(
            TextUpdated(
                ...
                lambda: gsm.player.get_upgrade_price_as_text(ShipUpgrade.ENGINE_ACCELERATION)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_engine_acc.add_conditional_override(
            lambda: gsm.player.get_upgrade_level(ShipUpgrade.ENGINE_ACCELERATION) >= gsm.player.get_upgrade_level_max(ShipUpgrade.ENGINE_ACCELERATION),
        ...
        c_magnet.add_element(
            TextUpdated(
                ...
                lambda: gsm.player.get_part_level(ShipPart.MAGNET)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_magnet.add_conditional_override(
            lambda: gsm.player.get_part_level(ShipPart.MAGNET) >= gsm.player.get_part_level_max(ShipPart.MAGNET),
        ...
        c_magnet_rad.add_element(
            TextUpdated(
                ...
                lambda: gsm.player.get_upgrade_price_as_text(ShipUpgrade.MAGNET_RADIUS)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_magnet_rad.add_conditional_override(
            lambda: gsm.player.get_upgrade_level(ShipUpgrade.MAGNET_RADIUS) >= gsm.player.get_upgrade_level_max(ShipUpgrade.MAGNET_RADIUS),
        ...
        c_magnet_str.add_element(
            TextUpdated(
                ...
                lambda: gsm.player.get_upgrade_price_as_text(ShipUpgrade.MAGNET_STRENGTH)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_magnet_str.add_conditional_override(
            lambda: gsm.player.get_upgrade_level(ShipUpgrade.MAGNET_STRENGTH) >= gsm.player.get_upgrade_level_max(ShipUpgrade.MAGNET_STRENGTH),
        ...
        c_weapon_1.add_element(
            TextUpdated(
                ...
                gsm.player.weapon_plasmagun.get_name,
                lambda: gsm.player.get_part_level(ShipPart.PLASMAGUN)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_weapon_1.add_conditional_override(
            lambda: gsm.player.get_part_level(ShipPart.PLASMAGUN) >= gsm.player.get_part_level_max(ShipPart.PLASMAGUN),
        ...
        c_weapon_1_proj.add_element(
            TextUpdated(
                ...
                lambda: gsm.player.get_upgrade_price_as_text(ShipUpgrade.PLASMAGUN_PROJECTILES)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_weapon_1_proj.add_conditional_override(
            lambda: gsm.player.get_upgrade_level(ShipUpgrade.PLASMAGUN_PROJECTILES) >= gsm.player.get_upgrade_level_max(ShipUpgrade.PLASMAGUN_PROJECTILES),
        ...
        c_weapon_1_cd.add_element(
            TextUpdated(
                ...
                lambda: gsm.player.get_upgrade_price_as_text(ShipUpgrade.PLASMAGUN_COOLDOWN)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_weapon_1_cd.add_conditional_override(
            lambda: gsm.player.get_upgrade_level(ShipUpgrade.PLASMAGUN_COOLDOWN) >= gsm.player.get_upgrade_level_max(ShipUpgrade.PLASMAGUN_COOLDOWN),
        ...
        c_weapon_2.add_element(
            TextUpdated(
                ...
                gsm.player.weapon_bomblauncher.get_name,
                lambda: gsm.player.get_part_level(ShipPart.BOMBLAUNCHER)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_weapon_2.add_conditional_override(
            lambda: gsm.player.get_part_level(ShipPart.BOMBLAUNCHER) >= gsm.player.get_part_level_max(ShipPart.BOMBLAUNCHER),
        ...
        c_weapon_2_rad.add_element(
            TextUpdated(
                "Radius: {}", fonts.small, color_white,
                lambda: gsm.player.get_upgrade_price_as_text(ShipUpgrade.BOMBLAUNCHER_RADIUS)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_weapon_2_rad.add_conditional_override(
            lambda: gsm.player.get_upgrade_level(ShipUpgrade.BOMBLAUNCHER_RADIUS) >= gsm.player.get_upgrade_level_max(ShipUpgrade.BOMBLAUNCHER_RADIUS),
        ...
        c_weapon_2_fuse.add_element(
            TextUpdated(
                ...
                lambda: gsm.player.get_upgrade_price_as_text(ShipUpgrade.BOMBLAUNCHER_FUSE)
            ),
            Allignment.LEFT_WALL,
            nudge=(12, 0)
        )
        c_weapon_2_fuse.add_conditional_override(
            lambda: gsm.player.get_upgrade_level(ShipUpgrade.BOMBLAUNCHER_FUSE) >= gsm.player.get_upgrade_level_max(ShipUpgrade.BOMBLAUNCHER_FUSE),
        ...
        if gsm.player.stats.cheat_cleavers:
            ...
            c_weapon_3.add_element(
                TextUpdated(
                    ...
                    gsm.player.weapon_meat.get_name,
                    lambda: gsm.player.get_part_level(ShipPart.LITERALLYAFUCKINGMEATCLEAVERLAUNCHER)
                ),
                Allignment.LEFT_WALL,
                nudge=(12, 0)
            )
            ...
            c_weapon_3.add_conditional_override(
                lambda: gsm.player.get_part_level(ShipPart.LITERALLYAFUCKINGMEATCLEAVERLAUNCHER) >= gsm.player.get_part_level_max(ShipPart.LITERALLYAFUCKINGMEATCLEAVERLAUNCHER),
            ...
            c_weapon_3_meat.add_element(
                TextUpdated(
                    ...
                    lambda: gsm.player.get_upgrade_price_as_text(ShipUpgrade.LITERALLYAFUCKINGMEATCLEAVERLAUNCHER_MEAT)
                ),
                Allignment.LEFT_WALL,
                nudge=(12, 0)
            )
            c_weapon_3_meat.add_conditional_override(
                lambda: gsm.player.get_upgrade_level(ShipUpgrade.LITERALLYAFUCKINGMEATCLEAVERLAUNCHER_MEAT) >= gsm.player.get_upgrade_level_max(ShipUpgrade.LITERALLYAFUCKINGMEATCLEAVERLAUNCHER_MEAT),
                lambda: c_weapon_3_meat.set_color(color_red)
            )

            self._containers.extend([c_weapon_3, c_weapon_3_meat])
        ...
        b_color1 = Switch(
            ...
            lambda: gsm.player.switch_color_profile(0),
            lambda: gsm.player.ship.color_profile == 0
        )
        ...
        b_color2 = Switch(
            ...
            lambda: gsm.player.switch_color_profile(1),
            lambda: gsm.player.ship.color_profile == 1
        )
        ...
        b_color3 = Switch(
            ...
            lambda: gsm.player.switch_color_profile(2),
            lambda: gsm.player.ship.color_profile == 2
        )
        ...
        b_color4 = Switch(
            ...
            lambda: gsm.player.switch_color_profile(3),
            lambda: gsm.player.ship.color_profile == 3
        )
        ...
        s_auto_shoot = Switch(
            ...
            gsm.player.switch_auto_shoot,
            gsm.player.is_auto_shooting
        )
        ...
        s_auto_heal = Switch(
            ...
            gsm.player.switch_auto_heal,
            gsm.player.is_auto_healing
        )
        ...
        b_model_left = Button(
            ...
            gsm.player.switch_ship_model_to_previous
        )
        ...
        b_model_right = Button(
            ...
            gsm.player.switch_ship_model_to_next
        )
        ...
        b_engine_speed = Button(
            ...
            lambda: gsm.player.buy_upgrade(ShipUpgrade.ENGINE_SPEED),
            lambda: gsm.player.can_buy_upgrade(ShipUpgrade.ENGINE_SPEED)
        )
        ...
        b_engine_acc = Button(
            ...
            lambda: gsm.player.buy_upgrade(ShipUpgrade.ENGINE_ACCELERATION),
            lambda: gsm.player.can_buy_upgrade(ShipUpgrade.ENGINE_ACCELERATION)
        )
        ...
        b_magnet_rad = Button(
            ...
            lambda: gsm.player.buy_upgrade(ShipUpgrade.MAGNET_RADIUS),
            lambda: gsm.player.can_buy_upgrade(ShipUpgrade.MAGNET_RADIUS)
        )
        ...
        b_magnet_str = Button(
            ...
            lambda: gsm.player.buy_upgrade(ShipUpgrade.MAGNET_STRENGTH),
            lambda: gsm.player.can_buy_upgrade(ShipUpgrade.MAGNET_STRENGTH)
        )
        ...
        b_weapon_1_proj_up = Button(
            ...
            lambda: gsm.player.buy_upgrade(ShipUpgrade.PLASMAGUN_PROJECTILES),
            lambda: gsm.player.can_buy_upgrade(ShipUpgrade.PLASMAGUN_PROJECTILES)
        )
        ...
        b_weapon_1_cd_up = Button(
            ...
            lambda: gsm.player.buy_upgrade(ShipUpgrade.PLASMAGUN_COOLDOWN),
            lambda: gsm.player.can_buy_upgrade(ShipUpgrade.PLASMAGUN_COOLDOWN)
        )
        ...
        b_weapon_2_rad_up = Button(
            ...
            lambda: gsm.player.buy_upgrade(ShipUpgrade.BOMBLAUNCHER_RADIUS),
            lambda: gsm.player.can_buy_upgrade(ShipUpgrade.BOMBLAUNCHER_RADIUS)
        )
        ...
        b_weapon_2_fuse_up = Button(
            ...
            lambda: gsm.player.buy_upgrade(ShipUpgrade.BOMBLAUNCHER_FUSE),
            lambda: gsm.player.can_buy_upgrade(ShipUpgrade.BOMBLAUNCHER_FUSE)
        )
        ...
        if gsm.player.stats.cheat_cleavers:
            b_weapon_3_meat_up = Button(
                ...
                lambda: gsm.player.buy_upgrade(ShipUpgrade.LITERALLYAFUCKINGMEATCLEAVERLAUNCHER_MEAT),
                lambda: gsm.player.can_buy_upgrade(ShipUpgrade.LITERALLYAFUCKINGMEATCLEAVERLAUNCHER_MEAT)
            )
            ...
            self._buttons.extend([b_weapon_3_meat_up])
