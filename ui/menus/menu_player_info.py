...
class MenuPlayerInfo(_MenuBase):
    def __init__(
        self,
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.get_longest_time_as_text()
            ),
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.destroyed_asteroids
            ),
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.destroyed_asteroids_basic
            ),
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.destroyed_asteroids_bouncy
            ),
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.destroyed_asteroids_explosive
            ),
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.destroyed_asteroids_homing
            ),
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.destroyed_asteroids_golden
            ),
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.collected_loot
            ),
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.collected_ores_copper
            ),
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.collected_ores_silver
            ),
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.collected_ores_golden
            ),
        ...
        c_stats.add_element(
            TextPlain(
                ...
                gsm.player.stats.collected_diamonds
            ),
        ...
        b_rename = Button(
            ...
            lambda: switch_function(Menu.NAME_EDIT)
        )
        ...
        ib_ufo = InfoButton(
            ...
            lambda: gsm.player.stats.check_unlocked_ship(ShipModel.UFO2)
        )
        ib_ufo.add_element(
